...
- NEVER use "work" as a verb in learning contexts. Never write "you work well with others" — say "you collaborate well with others" or "you learn well with others". Never write "working with others" — say "collaborating with others". For effort, never say "has worked hard" — say "has put real effort into", "has built", "has developed through consistent effort", "has committed to". The word "work" is banned — there is always a better alternative.
...
- OTHER LEARNERS — never "learning partners", "peers", "classmates" or "friends" when referring to the other children in the class
